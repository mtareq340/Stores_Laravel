                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">إضافة طلب للفرع
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{ route('admin.supplierorders.store' )}}" method="POST"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" disabled value="{{ $supplier->name }}" id="name"
                                                                    class="form-control"
                                                                    placeholder=""
                                                                    name="total_price">
                                                                    @error("name")
                                                        ...
                                                        <input type="text"  value="{{ $supplier->id }}" id="name"
