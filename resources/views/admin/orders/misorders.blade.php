        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-4 col-4 ">
                    <h3 class="content-header-title"> الفواتير الملغية </h3>
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard')}}">الرئيسية</a>
                                </li>
                                <li class="breadcrumb-item active"><a href="{{ route('admin.orders')}}"> الفواتير</a> 
                                </li>
                                <li class="breadcrumb-item active"> الفواتير الملغية
                                </li>
                            </ol>
                        </div>
                    </div>
