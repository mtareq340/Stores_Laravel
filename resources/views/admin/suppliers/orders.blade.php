        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title"> طلبات المورد </h3>
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"> طلبات المورد
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">جميع طلبات المورد </h4>
                                    ...
                                    <div class="heading-elements">
                                        <ul class="list-inline mb-0">
                                            ...
                                            <li><a data-action="close"><i class="ft-x"></i></a></li>
                                                ...
                                                <table id="orderTable" class="table table-striped table-bordered table-hover {{ count($supplierorders) > 0 ? 'datatable' : '' }} " >
                                                    <thead>
                                                        <tr>
                                                    ...
                                                    <tr class="item{{$supplierorder->id}}">
                                                            ...
                                                            @endif       
                                                            <td>
                                                                <!-- <button class="show-modal btn btn-xs btn-success" data-id="{{$supplierorder->id}}"  data-name="{{$supplierorder->supplier['name']}}" data-total_price="{{$supplierorder->total_price}}" data-paid_price="{{$supplierorder->paid_price}}" data-remaining_price="{{$supplierorder->remaining_price}}">
                                                                <span class="glyphicon glyphicon-eye-open"></span> عرض</button> -->
                                                                <button class="edit-modal btn btn-xs btn-success" data-id="{{$supplierorder->id}}"  data-name="{{$supplierorder->supplier['name']}}" data-total_price="{{$supplierorder->total_price}}" data-paid_price="{{$supplierorder->paid_price}}" data-remaining_price="{{$supplierorder->remaining_price}}">
                                                                ...
                                                                <!-- <a href="{{ route('admin.supplierorders.edit',[$supplierorder->id]) }}" class="btn btn-xs btn-info">تعديل</a> -->
...
$('.modal-footer').on('click', '.edit', function() {
            $.ajax({
                type: 'POST',
                url: "{{ route('admin.supplierorders.update')}}",
                data: {
