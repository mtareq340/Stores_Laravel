...
<div class="app-content content">
        <div class="content-wrapper">
            ...
            <p>
        <a href="{{ route('admin.products.create') }}" class="btn btn-success">اضافة جديدة</a>
                            ...
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body card-dashboard panel-body table-responsive">
                                        <table
                                            class="table table-bordered table-striped {{ count($products) > 0 ? 'datatable' : '' }} ">
                                            <thead>
                                            <tr>
                                                <th> الرقم</th>
                                                <th> الخدمة</th>
                                           ...
                                           @foreach($products as $index=>$product)
                                                    <tr>
                                                        ...
                                                        <td>{{ $product->getChangedPrice() }} </td>
                                                        <td>{{ $product->getCountable() }} </td>
                                                        <td>
